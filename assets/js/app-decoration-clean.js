...
async function init(){try{
  ...
  const decorationsUrl='https://raw.githubusercontent.com/doddaersen/mambo-demo/main/data/decorations.json?v=main-decoration-80';
  const [master,decorations,definitionOverrides]=await Promise.all([loadJson(masterUrl),loadJson(decorationsUrl),loadDefinitionOverrides()]);
