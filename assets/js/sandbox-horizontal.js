...
const fixedIcons={
  ...
  'mambo:binding-001':['kotes-csavaros','csavaros-album','csavaros-kotes','screw-post-binding'],
...
const aliases={
  ...
  'füzet':['formatum-fuzet','fuzet','booklet'],'íves cérnafűzés':['fuzes-cerna','cernafuzes'],'cérnafűzés':['fuzes-cerna','cernafuzes'],'irkafűzés':['fuzes-irka','irkafuzes','irka-fuzes'],'irka-fűzés':['fuzes-irka','irkafuzes','irka-fuzes'],
  ...
  'kopt kötés':['kotes-kopt','kopt-kotes','coptic-binding'],'ragasztókötés':['kotes-ragaszto','kotes-ragasztokotes','ragasztokotes','ragasztott-kotes','perfect-binding'],
  'gyűrűs mappa':['kotes-gyurus','gyurus-dosszie','ring-binder'],'gyűrűs dosszié':['kotes-gyurus','gyurus-dosszie','ring-binder'],'spirálkötés':['kotes-spiral','spiral-kotes'],
  ...
  'hosszöltéses kötés':['fuzes-longstich','kotes-hosszoltes','hosszolteses-kotes','long-stitch-binding'],'szalaggal kötött kötés':['kotes-szalag','szalaggal-kotott','ribbon-binding'],'szalaggal kötött':['kotes-szalag','szalaggal-kotott','ribbon-binding'],
  'nyitott gerinc':['gerinc-nyitott','nyitott-gerinc','open-spine'],'fedett / gerinclemezes gerinc':['gerinc-fedett','fedett-gerinc','covered-spine'],'fedett gerinc':['gerinc-fedett','fedett-gerinc','covered-spine'],
